...
DPP_MODULE_REGISTRATION_IMPLEMENT(MLResurrectionModule,"MLResurrectionModule");

//=================================================================

MLResurrectionModule::MLResurrectionModule() : dpp::base_module() {}


MLResurrectionModule::~MLResurrectionModule() {
  //if (is_initialized())
  this->reset();
}
...
void MLResurrectionModule::initialize(const datatools::properties& myConfig,
  ...
  std::cout << "MLResurrection module initialized..." << std::endl;
...
//! [MLResurrectionModule::Process]
dpp::base_module::process_status MLResurrectionModule::process(datatools::things& event) {
...
//! [MLResurrectionModule::reset]
void MLResurrectionModule::reset() {
